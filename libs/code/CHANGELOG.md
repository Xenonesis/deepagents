...
## [0.1.76](https://github.com/Xenonesis/deepagents/compare/deepagents-code==0.1.75...deepagents-code==0.1.76) (2026-09-23)
...
* **code:** add durable Debug Console cost breakdown ([#6246](https://github.com/Xenonesis/deepagents/issues/6246)) ([c981748](https://github.com/Xenonesis/deepagents/commit/c9817483eeea620b1523dcfaed2802269c79d4fe))
...
* **code:** add thread picker ([#6197](https://github.com/Xenonesis/deepagents/issues/6197)) ([9d3da12](https://github.com/Xenonesis/deepagents/commit/9d3da1287ba5656d52ad7f2c75cf9062d46a4959))
...
* **code:** condense status bar cwd from the middle, tail intact ([#6252](https://github.com/Xenonesis/deepagents/issues/6252)) ([f733893](https://github.com/Xenonesis/deepagents/commit/f7338933e5ebd6959820023efb66704d6ab8ce7f))
...
* **code:** copy highlighted thread ID with `ctrl+c` ([#6431](https://github.com/Xenonesis/deepagents/issues/6431)) ([0a6bd89](https://github.com/Xenonesis/deepagents/commit/0a6bd899a0760af76bca025ea6af39997b78e611))
...
* **code:** move MCP onto FastMCP and `langchain.mcp` ([#5922](https://github.com/Xenonesis/deepagents/issues/5922)) ([0692ef1](https://github.com/Xenonesis/deepagents/commit/0692ef1550568a585afe48705d54a4aa07002697))
...
* **code:** show `read_file` arguments when expanded ([#6392](https://github.com/Xenonesis/deepagents/issues/6392)) ([902905f](https://github.com/Xenonesis/deepagents/commit/902905f2508fe74dc0ba13d857f502e8ddbc807e))
...
* **code:** show cache timing in the footer ([#6394](https://github.com/Xenonesis/deepagents/issues/6394)) ([f4c226b](https://github.com/Xenonesis/deepagents/commit/f4c226b21cc07ee6cee6472ed726f86e69b8af36))
...
* **code:** show human invocations in usage teardown ([#6500](https://github.com/Xenonesis/deepagents/issues/6500)) ([0779f31](https://github.com/Xenonesis/deepagents/commit/0779f314841ec4216a189b70c615d06194731ecd))
...
* **code:** align file and console debug log formatting ([#6426](https://github.com/Xenonesis/deepagents/issues/6426)) ([6c219d3](https://github.com/Xenonesis/deepagents/commit/6c219d3a39a869b55c5ec434acf76f84217eb002))
* **code:** align prompt clipboard word deletion ([#6345](https://github.com/Xenonesis/deepagents/issues/6345)) ([777d633](https://github.com/Xenonesis/deepagents/commit/777d6336de3c7f1b6759a3f092fbfeddc4c54499))
* **code:** anchor editable refresh to its checkout ([#6455](https://github.com/Xenonesis/deepagents/issues/6455)) ([a6d844d](https://github.com/Xenonesis/deepagents/commit/a6d844d47126bb905f30e76569110cd68294a0b3))
...
* **code:** clarify compaction prompt ([#6429](https://github.com/Xenonesis/deepagents/issues/6429)) ([15cf630](https://github.com/Xenonesis/deepagents/commit/15cf6301e49e00963df876b6697fcc7c42d027d8))
* **code:** clarify thread message count header ([#6428](https://github.com/Xenonesis/deepagents/issues/6428)) ([e775680](https://github.com/Xenonesis/deepagents/commit/e775680e1cb5a52ba816e6c4663a647a7025d566))
* **code:** clarify unknown effort default ([#6337](https://github.com/Xenonesis/deepagents/issues/6337)) ([5ee1073](https://github.com/Xenonesis/deepagents/commit/5ee1073e9ab2fe9a286becb27ec7e694a4b3de4f))
* **code:** clean up new sandboxes when setup fails ([#6475](https://github.com/Xenonesis/deepagents/issues/6475)) ([1ec8996](https://github.com/Xenonesis/deepagents/commit/1ec8996c91fa6f68b3ec8145f279b8c1dea5dc20))
...
* **code:** deduplicate footer picker clicks ([#6344](https://github.com/Xenonesis/deepagents/issues/6344)) ([811e927](https://github.com/Xenonesis/deepagents/commit/811e92738ffa491e991b9dea6573fff57a84d938))
* **code:** deduplicate mixed-ID model usage ([#6432](https://github.com/Xenonesis/deepagents/issues/6432)) ([bdca132](https://github.com/Xenonesis/deepagents/commit/bdca132ee7fbf84ab611392adb6846a1c545d26c))
...
* **code:** delay hook status in footer ([#6322](https://github.com/Xenonesis/deepagents/issues/6322)) ([7f9e8ed](https://github.com/Xenonesis/deepagents/commit/7f9e8ed3a555933902045792da9bb184950ee7b2))
...
* **code:** diagnose workspace binding and runtime refusals ([#6384](https://github.com/Xenonesis/deepagents/issues/6384)) ([f9ffd51](https://github.com/Xenonesis/deepagents/commit/f9ffd51154296f81f832f5f184407bc0067acbaf))
...
* **code:** keep absolute paths in normal input mode ([#6379](https://github.com/Xenonesis/deepagents/issues/6379)) ([141ce98](https://github.com/Xenonesis/deepagents/commit/141ce9851b876f733ef390ead3edbc509536a8e8))
* **code:** keep installation locks outside the uv tool directory ([#6472](https://github.com/Xenonesis/deepagents/issues/6472)) ([ec128d1](https://github.com/Xenonesis/deepagents/commit/ec128d14bd59561e955115c39b8d2a1cdd4dc720))
...
* **code:** keep prompt recall out of file picker ([#6494](https://github.com/Xenonesis/deepagents/issues/6494)) ([86b7f85](https://github.com/Xenonesis/deepagents/commit/86b7f85af7424ff2491206070897818d71e163cb))
* **code:** keep thread picker resume failures recoverable ([#6476](https://github.com/Xenonesis/deepagents/issues/6476)) ([6a41c53](https://github.com/Xenonesis/deepagents/commit/6a41c537fb1d4af7a34ef2340fff0f1c088548f4))
...
* **code:** pin resumed history to newest message ([#6225](https://github.com/Xenonesis/deepagents/issues/6225)) ([9b5ca38](https://github.com/Xenonesis/deepagents/commit/9b5ca384ff727f16c4f66a13308170cfba899b97))
...
* **code:** preserve `ask_user` consent receipts across user turns ([#6307](https://github.com/Xenonesis/deepagents/issues/6307)) ([ca00490](https://github.com/Xenonesis/deepagents/commit/ca004904d1e48385d805d6e3b7f62f82739cfc11))
...
* **code:** read `hooks.json` as UTF-8 in the legacy hook loader ([#6501](https://github.com/Xenonesis/deepagents/issues/6501)) ([61bada8](https://github.com/Xenonesis/deepagents/commit/61bada8bcbb62a40bfbe0345831228756f0ba353))
* **code:** reconcile interrupted tool requests ([#6321](https://github.com/Xenonesis/deepagents/issues/6321)) ([376e988](https://github.com/Xenonesis/deepagents/commit/376e988f98fea5e501050efe250d683259e551f5))
...
* **code:** refresh token and cost breakdown while open ([#6520](https://github.com/Xenonesis/deepagents/issues/6520)) ([22524ed](https://github.com/Xenonesis/deepagents/commit/22524edb7702d6fb31ffefd2d7d19549b17d2ed6))
...
* **code:** remove contradictory and invalid system-prompt instructions ([#6072](https://github.com/Xenonesis/deepagents/issues/6072)) ([2776a66](https://github.com/Xenonesis/deepagents/commit/2776a66a955976e4fffbf4cd8612828012feaebc))
...
* **code:** replace composer with prompt search and prevent query feedback ([#6346](https://github.com/Xenonesis/deepagents/issues/6346)) ([a52ecea](https://github.com/Xenonesis/deepagents/commit/a52ecea1f4b159a5ec0c667c6d05e26ea701db30))
...
* **code:** restrict auto classifier IDs to the review batch enum ([#6250](https://github.com/Xenonesis/deepagents/issues/6250)) ([6152733](https://github.com/Xenonesis/deepagents/commit/6152733cbd6b73709a704f3f41b93e2576c5cd52))
* **code:** retry bare `openai.APIError` raised mid-stream ([#6499](https://github.com/Xenonesis/deepagents/issues/6499)) ([0f95915](https://github.com/Xenonesis/deepagents/commit/0f959156b828f9deb08438b71dbc9a65c13b1714))
...
* **code:** scroll overflowing chat input pastes ([#6382](https://github.com/Xenonesis/deepagents/issues/6382)) ([b522fd4](https://github.com/Xenonesis/deepagents/commit/b522fd4a74b2349b25f3f1f630265f7e456430ee))
* **code:** separate access-policy compatibility from runtime identity ([#6386](https://github.com/Xenonesis/deepagents/issues/6386)) ([95c7630](https://github.com/Xenonesis/deepagents/commit/95c763059fdec12991232fc63418755ba568af74))
...
* **code:** show loading labels for thread details ([#6430](https://github.com/Xenonesis/deepagents/issues/6430)) ([5c09b92](https://github.com/Xenonesis/deepagents/commit/5c09b9291924df7f67fbc73fda2214a0a50005ea))
* **code:** show session cost warnings in a modal ([#6393](https://github.com/Xenonesis/deepagents/issues/6393)) ([c1395da](https://github.com/Xenonesis/deepagents/commit/c1395dab009690a30d495bfcae33fb92f62d08c4))
...
* **code:** silence non-media path decoder traces ([#6427](https://github.com/Xenonesis/deepagents/issues/6427)) ([3693e9d](https://github.com/Xenonesis/deepagents/commit/3693e9d01a94a4e881cbb5f92438adfec27cd77e))
...
* **code:** suppress historical cost warnings on resume ([#6471](https://github.com/Xenonesis/deepagents/issues/6471)) ([13170ea](https://github.com/Xenonesis/deepagents/commit/13170ea5b07206c94d535141af7e311666f17b7b))
...
* **code:** use UTF-8 for prompts and skill files ([#6474](https://github.com/Xenonesis/deepagents/issues/6474)) ([8feaa0f](https://github.com/Xenonesis/deepagents/commit/8feaa0fcce7ee967b1411c247d6f4eab202aa66d))
...
* **code:** warm lazy MCP caches off the event loop ([#6517](https://github.com/Xenonesis/deepagents/issues/6517)) ([e6419a6](https://github.com/Xenonesis/deepagents/commit/e6419a6fbabf18d8232fb6b0a0283bc933b4bae3))
...
* **code:** wrap debug logs before the scrollbar ([#6219](https://github.com/Xenonesis/deepagents/issues/6219)) ([ca7999a](https://github.com/Xenonesis/deepagents/commit/ca7999a8a9984e110a3b80d2e5f71dbe895f58ec))
...
* **code:** log thread loading phase timings ([#6490](https://github.com/Xenonesis/deepagents/issues/6490)) ([ad038f8](https://github.com/Xenonesis/deepagents/commit/ad038f87e07e13791ff9b1e239326d2c959fd412))
...
* **code:** rank checkpoint row IDs before loading blobs ([#6488](https://github.com/Xenonesis/deepagents/issues/6488)) ([933eaea](https://github.com/Xenonesis/deepagents/commit/933eaeaddea12d1d6fcd0a8cd7716e948ff1df58))
* **code:** rank message row IDs before loading prompts ([#6489](https://github.com/Xenonesis/deepagents/issues/6489)) ([17ea378](https://github.com/Xenonesis/deepagents/commit/17ea378fcb04f15c916e64eaf24a833b3a63c504))
* **code:** reuse Auto classifier history ([#6056](https://github.com/Xenonesis/deepagents/issues/6056)) ([44926fa](https://github.com/Xenonesis/deepagents/commit/44926fa8f26dfb24d9a0e3ded335c48b123d193d))
* **code:** skip transcript scan on prompt submit ([#6402](https://github.com/Xenonesis/deepagents/issues/6402)) ([443d34b](https://github.com/Xenonesis/deepagents/commit/443d34bfde4f22cbc7f9ac71be766922a041e08c))
