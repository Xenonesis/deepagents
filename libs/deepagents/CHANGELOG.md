...
## [0.7.15](https://github.com/Xenonesis/deepagents/compare/deepagents==0.7.14...deepagents==0.7.15) (2026-09-15)
...
* **sdk:** add `files` state only for state backends ([#5643](https://github.com/Xenonesis/deepagents/issues/5643)) ([63c13f3](https://github.com/Xenonesis/deepagents/commit/63c13f3e6bc79a5304e542178ac410b517c64c31))
* **sdk:** batch concurrent `ContextHubBackend` mutations ([#5471](https://github.com/Xenonesis/deepagents/issues/5471)) ([822f7c9](https://github.com/Xenonesis/deepagents/commit/822f7c9b02e6d99bdb46b5545bb2543783c01769))
...
* **sdk:** make `BackendProtocol.glob` recursive for bare patterns ([#5026](https://github.com/Xenonesis/deepagents/issues/5026)) ([32f35d5](https://github.com/Xenonesis/deepagents/commit/32f35d5e01f460549c10365eb569978909f5c969))
* **sdk:** offload conversation history to distinct session ID when summarizing ([#5470](https://github.com/Xenonesis/deepagents/issues/5470)) ([fa55c52](https://github.com/Xenonesis/deepagents/commit/fa55c52fe774462b2775c0d77dcf811d6dfd0e35))
